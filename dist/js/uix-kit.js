  ...
  module.DYNAMIC_DD_LIST.documentReady = function ($) {
    $('[data-ajax-dynamic-dd-json]').each(function () {
      var $this = $(this),
          ...
          thisChange = true,
          curID;
      if (dynamic_dropdown_list_json_js_typeof(emptyTxt1) === ( true ? "undefined" : undefined)) emptyTxt1 = '-';
      if (dynamic_dropdown_list_json_js_typeof(emptyTxt2) === ( true ? "undefined" : undefined)) emptyTxt2 = '-';
      if (dynamic_dropdown_list_json_js_typeof(emptyTxt3) === ( true ? "undefined" : undefined)) emptyTxt3 = '-';
      if (dynamic_dropdown_list_json_js_typeof(jsonFile) === ( true ? "undefined" : undefined)) jsonFile = '';
      if (dynamic_dropdown_list_json_js_typeof(toData) === ( true ? "undefined" : undefined)) toData = '';
      if (dynamic_dropdown_list_json_js_typeof(method) === ( true ? "undefined" : undefined)) method = 'POST';
      if (dynamic_dropdown_list_json_js_typeof(autoExpand) === ( true ? "undefined" : undefined)) autoExpand = true;
      if (dynamic_dropdown_list_json_js_typeof(associated) === ( true ? "undefined" : undefined)) associated = '#demo';
      if (dynamic_dropdown_list_json_js_typeof(associated2) === ( true ? "undefined" : undefined)) associated2 = '#demo2';
